                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Form About</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="body">
                            <form action="{{route('abouts.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" name="title" placeholder=" Short Title" class="form-control"  required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Mission</label>
                                    <textarea class="form-control" id="mission" name="mission" placeholder="write somthing..." rows="5" cols="30" required></textarea>
                                </div>
                                
                                <div class="form-group">
                                    <label>Vision</label>
                                    <textarea class="form-control" id="vision" name="vision" placeholder="write somthing..." rows="5" cols="30" required></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Quality Image</label>
                                    <input type="file" class="form-control" name="quality_image" class="form-control" required>
                                </div>
                                <br>
